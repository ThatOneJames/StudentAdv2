...
<body>
	...
	<div class=body><br/>
		...
		<form action="adminRegister.php" method="POST">
			...
			<center><a href="adminLogin.php">Already have an account? Login Here!</a></center>
	</div>
</body>
</html>
...
if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO admin (firstname, middlename, lastname, employeeid, password) VALUES (?, ?, ?, ?, ?)";
    
    // Prepare the SQL statement
    $stmt = $conn->prepare($sql);
    
    // Bind parameters and execute the statement
    $stmt->bind_param("sssis", $firstname, $middlename, $lastname, $employeeid, $password);
