...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    // Example:
    $query = "SELECT * FROM adviser WHERE studentno = ? AND password = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("is", $studentno, $password);
    $stmt->execute();
...
<body>
    ...
    <center>
	 ...
	 <div class="body">
        <br/><h2>Adviser Login Page</h2><hr class="xsmall">
        <form action="adviserLogin.php" method="POST">
            <table align="center">
                <tr>
                    <td> Enter Student Number Number:</td>
            ...
            <center><a href="adviserRegister.php">Don't have an account? Register here!</a></center>
        </form>
        <?php
